...
class BaseLivre:
    def __init__(self, ressource, bibliotheque_dir):
        self.ressource = ressource
        self.bibliotheque_dir = bibliotheque_dir             """#modif """
    ...
    def ajouter_depuis_url(self):                           """#modif """
        if not os.path.exists(self.bibliotheque_dir):  
            os.mkdir(self.bibliotheque_dir)
        ...
        with open(os.path.join(self.bibliotheque_dir, nom_fichier), 'wb') as f:
            f.write(book.content)

        self.ressource = os.path.join(self.bibliotheque_dir, nom_fichier)
...
# Exemple d'utilisation avec la spécification du répertoire de la bibliothèque
bibliotheque_dir = "/chemin/vers/la/bibliotheque"
livre = BaseLivre("https://math.univ-angers.fr/~jaclin/biblio/livres/delly_-_l_exilee.epub", bibliotheque_dir)
